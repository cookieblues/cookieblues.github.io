...
df = pd.read_csv("data/processed/dirichlet_multinomial_posterior.csv")
vote_cols = list()
...
for party_idx in range(15):
    ...
    mean_df[party] = 100*df_new[n_days*party_idx:n_days*(party_idx+1)].values

mean_df.to_csv("data/processed/mean_polls.csv", index=True, index_label="date")
