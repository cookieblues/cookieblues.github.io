...
# Figure
fig = plt.figure(figsize=(1700/96, 1700/(96*1.6)))
...
#     draw_ellipse(
#         # nb.theta_[int(c)],
#         # np.diag(np.diag(nb.sigma_[int(c)])),
#         nb.means[c],
#         nb.covs[c],
...
#         ax=ax
#     )
# for c in reversed(nb.classes):
# #for c in reversed(nb.classes_):
#     draw_ellipse(
#         # nb.theta_[int(c)],
#         # np.diag(np.diag(nb.sigma_[int(c)])),
#         nb.means[c],
...
decision_contour(nb, X, t, fig, ax, cmap=colormap)
