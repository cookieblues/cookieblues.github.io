...
<video width="500" height="310" loop muted autoplay>
    <source src="{{ site.url }}/pages/extra/bslialo-notes-9c/fig_02.mp4" type="video/mp4">
</video>
...
<video width="500" height="310" loop muted autoplay>
    <source src="{{ site.url }}/pages/extra/bslialo-notes-9c/fig_03.mp4" type="video/mp4">
</video>
...
<video width="500" height="310" loop muted autoplay>
    <source src="{{ site.url }}/pages/extra/bslialo-notes-9c/fig_04.mp4" type="video/mp4">
</video>
...
where $e$ is [Euler's number](https://en.wikipedia.org/wiki/E_(mathematical_constant)){:target="_blank"}. We start by finding the antiderivative of $\frac{1}{x}$, which from <a href="{{ site.url }}/bslialo-notes-9b">notes 9b</a> we know is $\ln x$, and then we can compute the integral
